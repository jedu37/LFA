...
public class SuffixCalculatorBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements SuffixCalculatorVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitNumber(SuffixCalculatorParser.NumberContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitFullExp(SuffixCalculatorParser.FullExpContext ctx) { return visitChildren(ctx); }
}